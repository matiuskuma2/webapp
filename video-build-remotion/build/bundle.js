...
function calculateTotalFrames(totalDurationMs, fps) {
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(jsx_runtime.Fragment, { children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
    esm.Composition,
    {
      ...
      calculateMetadata: ({ props }) => {
        ...
        console.log("[calculateMetadata] projectJson scenes:", (_a = pj.scenes) == null ? void 0 : _a.length);
        console.log("[calculateMetadata] first scene image:", (_e = (_d = (_c = (_b = pj.scenes) == null ? void 0 : _b[0]) == null ? void 0 : _c.assets) == null ? void 0 : _d.image) == null ? void 0 : _e.url);
        return {
          durationInFrames,
          fps,
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "video-build-remotion:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkvideo_build_remotion"] = self["webpackChunkvideo_build_remotion"] || [];
