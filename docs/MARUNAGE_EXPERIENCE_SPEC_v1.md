...
| 操作 | API | 巻き戻し先 | ボード表示 |
|---|---|---|---|
| 「リトライ」押下 | `POST /api/marunage/:projectId/retry` | error_phase に応じた巻き戻し（v3 計画書 §5-4 参照） | 失敗箇所を「生成中」に戻し、ポーリング再開 |
